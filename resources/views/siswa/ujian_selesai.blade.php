...
{{-- ─── Hero Banner ─── --}}
<div style="background:linear-gradient(135deg,#0f172a,#1e3a5f);border-radius:24px;padding:2.5rem;color:white;margin-bottom:1.5rem;display:flex;align-items:center;gap:2rem;flex-wrap:wrap;position:relative;overflow:hidden;" class="fade-up">
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1.5rem;" class="fade-up delay-1">

    <div style="background:white;border-radius:16px;padding:1.5rem;border:1px solid #e2e8f0;box-shadow:0 1px 4px rgba(0,0,0,.04);text-align:center;">
...
{{-- ─── Info Detail Ujian ─── --}}
<div class="glass-card fade-up delay-2" style="margin-bottom:1.5rem;">
...
{{-- ─── Tombol Navigasi ─── --}}
<div style="display:flex;gap:1rem;flex-wrap:wrap;" class="fade-up delay-2">
