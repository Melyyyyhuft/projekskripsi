    ...
    <div class="glass-card" style="width: 100%; max-width: 500px; z-index: 2; position: relative;">
        ...
        <form action="{{ url('/register') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" required placeholder="Sesuai Ijazah / Akta">
            </div>

            <div class="form-group">
                <label class="form-label" for="email">E-mail Aktif</label>
                <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" required placeholder="Contoh: siswa@gmail.com">
            </div>
